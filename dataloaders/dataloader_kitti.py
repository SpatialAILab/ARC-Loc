...
class SatGrdDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        with open(calib_file_name, 'r') as f:
            ...
            for line in lines:
                ...
                if 'P_rect_02' in line:
                    ...
                    fov_x = 2 * np.arctan(GrdImg_W / (2 * fx)) * (180 / np.pi) # horizontal FoV
                    
                    fov_deg = torch.tensor([fov_x], dtype=torch.float32)
                    break
        ...
        return sat_map, grd_left_imgs[0], left_camera_k, gt_loc, r, fov_deg
